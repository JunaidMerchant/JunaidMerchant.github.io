...
### <a href="mailto:merchantjs@gmail.com"><i class="fas fa-fw fa-envelope " style="color:DarkSlateGray" aria-hidden="true"></i></a>&ensp;<a href="https://github.com/JunaidMerchant"><i class="fab fa-fw fa-github " style="color:Black" aria-hidden="true"></i></a>&ensp;<a href="https://www.linkedin.com/in/junaid-s-merchant"><i class="fab fa-fw fa-linkedin " style="color:DarkSteelBlue" aria-hidden="true"></i></a>&ensp;<a href="https://scholar.google.com/citations?user=D5wXfjoAAAAJ"><i class="ai ai-google-scholar " style="color:DarkSteelBlue" aria-hidden="true"></i></a>&ensp;<a href="https://orcid.org/0000-0002-4315-6211"><i class="ai ai-orcid ai-fw " style="color:YellowGreen" aria-hidden="true"></i></a>&ensp;<a href="https://osf.io/85skm/"><i class="ai ai-osf ai-fw " style="color:DarkSteelBlue" aria-hidden="true"></i></a>    
...
**2025 - current** | <span style="color:darkred">**Lead Data Scientist**</span> | **Pivot Path Solutions, LLC**  
Defense Health Agency / MTEC Contract; Fairfax, Virginia    
*Data science lead building a database from 200M+ civilian and military health records for epidemiological analysis of hearing loss. MTEC Award No. MTEC-24-01-MPAI-017* Project Manager: Chip Sampson

**2022 - 2025** | <span style="color:darkred">**Research Faculty: Data Science**</span> | **Big Data for Health Equity**  
...
1. Xie, H., Moraczewski, D., McNaughton, K. A., Warnell, K. R., **Merchant, J. S.**, Kirby, L. A., & Redcay, E. (2026). Functional Connectivity During Social Reward Processing in Autistic and Neurotypical Adolescents. Brain and Behavior, 16(5), e71378.
1. Abdurokhmonova, G., Taylor-Robinette, E. K., McDorman, S. A., Ramirez, A. G., **Merchant, J. S.**, Gabrieli, J. D., & Romeo, R. R. (2026). Parallel contributions of socioeconomic status and bilingual experiences on executive function and the brain in young children. Brain and language, 276, 105737.
...
1. **Merchant, J. S.**, Glaros, S., Edakoth, E., Harris, R., Tchangalova, N., & Redcay, E. (2025). Brain bases of real-time social interaction: A meta-analytic investigation of human neuroimaging studies. Aperture neuro, 5, 10-52294.
1. **Merchant, J. S.**, Nguyen, T. T., Makres, K., & Evans, C. R. (2025). Intersectional inequities in suicide ideation by race, sexual orientation, and gender among US high school students in the pre-and post-2020 waves of the YRBSS: an application of random effects intersectional MAIHDA. American Journal of Epidemiology, 194(9), 2540-2552.
1. Nguyen, Q. C., Doumbia, R., Nguyen, T. T., Yue, X., Mane, H., **Merchant, J.**, ... & He, X. (2025). Changes in the Neighborhood Built Environment and Chronic Health Conditions in Washington, DC, in 2014-2019: Longitudinal Analysis. JMIR Formative Research, 9(1), e74195.
1. Alibilli, A. S., Jain, V., Mane, H., Yue, X., Ratzki-Leewing, A., **Merchant, J. S.**, ... & Nguyen, T. T. (2025). Harnessing Facebook to investigate real-world mentions of adverse events of glucagon-like peptide-1 receptor agonist (GLP-1 RA) medications: observational study of Facebook posts from 2022 to 2024. JMIR infodemiology, 5, e73619.
...
&ensp;&ensp;  - Brainhack Global DC | 2019  
...
* **MRI Software/Toolboxes**: Considerable experience with SPM, AFNI, fMRIprep, NiMARE, MRIcroGL, CoSMoMVPA, Brain Connectivity Toolbox, Decoding Toolbox. Some experience with Nilearn, NLtools, NiBabel, Connectome Workbench, FSL, Freesurfer, and Network Based Statistics.
...
## References
**Chip Sampson** 
| R&D Project Manager, Pivot Path Solutions   
&ensp; csampson@pivotpathsolutions.com    
**Dr. Thu Nguyen** 
...
**Google Scholar**: https://scholar.google.com/citations?user=D5wXfjoAAAAJ   
